<template>
  <div class="main" style="padding:10px;">
    ...
    >
      ...
      <el-table-column prop="cron" label="定时构建" show-overflow-tooltip min-width="100">
        <template slot-scope="scope">
          <el-popover
            placement="right"
            width="500"
      ...
      <div class="demo-drawer__content">
        <el-form ref="editForm" :size="themeSize" :model="editForm" :rules="editFormRules" label-width="160px">
          ...
          <el-form-item label="定时构建" prop="cron">
            <el-input v-model="editForm.cron" placeholder="定时构建cron表达式" />
          </el-form-item>
        </el-form>
        <!-- 取消、提交 -->
    ...
    >
      <div class="demo-drawer__content">
        <el-form ref="addForm" :size="themeSize" :model="addForm" label-width="160px" :rules="addFormRules">
          ...
          <el-form-item label="定时构建" prop="cron">
            <el-input v-model="addForm.cron" placeholder="定时构建cron表达式" />
          </el-form-item>
        </el-form>
        <!-- 取消、提交 -->
        <div class="demo-drawer__footer">
...
import ReportHistory from '@/views/apiTest/reportMgr/ReportHistory'
