...
export function getTestReportDetail(pk, params) {
  return request({
    url: '/api_test/test/report/detail/' + pk + '/',
    method: 'get',
    params
  })
}
...
export function updateTestReport(pk, data) {
  return request({
    url: '/api_test/test/report/update/' + pk + '/',
    method: 'patch',
    data
  })
}
...
export function deleteTestReport(pk) {
  return request({
    url: '/api_test/test/report/del/' + pk + '/',
    method: 'delete'
  })
}
...
export function getPytestHtml(pk, params) {
  return request({
    url: '/api_test/test/report/pytest_html/' + pk + '/',
    method: 'get',
    params
  })
}
...
export function getJenkinsAllure(pk, params) {
  return request({
    url: '/api_test/test/report/jenkins_allure/' + pk + '/',
    method: 'get',
    params
  })
}
...
export function getTestLogs(pk, params) {
  return request({
    url: '/api_test/test/report/logs/' + pk + '/',
    method: 'get',
    params
  })
}
