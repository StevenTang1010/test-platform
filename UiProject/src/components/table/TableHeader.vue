<template>
  ...
  >
    <el-card :body-style="{padding: '0px'}" shadow="never">
      <div slot="header" class="wrapper">
        <el-tooltip class="item" effect="dark" content="点击展开/收起" placement="top">
          <el-link :underline="false" @click="collapsed">
            {{ title }}
            <i v-if="showArrow" :class="showSearchContent ? 'el-icon-caret-bottom' : 'el-icon-caret-top'" />
          </el-link>
        </el-tooltip>
