...
from apps.user_auth.views import MyTokenObtainPairView, LogoutAPIView, UserProfileViewSet
from apps.user_auth.ldap_auth import LoginAuth, LogoutAuth, CheckLogin
