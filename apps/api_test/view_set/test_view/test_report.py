...
from apps.api_test.models import TestReport
from apps.api_test.filters import TestReportFilter
from apps.api_test.serializers import TestReportSerializer, TestReportDeserializer
from apps.api_test.view_set.base import JsonResponse
from runner.config import cf


class TestReportViewSet(ApiTestBaseViewSet):
