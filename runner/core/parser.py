...
@description:参数解析器，解析用例当中引用变量、自定义方法
"""
...
from runner.core import loader, exceptions, utils
from runner.core.models import VariablesMapping, FunctionsMapping
...
def get_mapping_function(
    ...
    if function_name in functions_mapping:
        ...
        from runner.core.ext import uploader
